...
<head>
    ...
    <script>
        tinymce.init({
            ...
            toolbar: 'fullscreen code autoresize | blocks h1 h2 codesample blockquote link  align | image bullist numlist checklist  indent outdent|bold italic underline strikethrough |  image media table mergetags |  spellcheckdialog a11ycheck typography |  lineheight |  emoticons charmap | removeformat',
