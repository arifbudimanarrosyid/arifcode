        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="flex mb-5 overflow-hidden ">
                <div class="px-4 sm:px-0">
                    ...
                    <h1 class="mt-4 text-base text-gray-600 dark:text-gray-400">at
                        <span class="text-lg @if ($post->is_featured)
                    ...
                    <div class="w-full ">
                        ...
                        <form method="POST" action="{{ route('comment.update', $comment) }}">
                            ...
                            <textarea id="message" rows="3" name="body"
                                ...
                                maxlength="255"
                                placeholder="Leave a message...">{{ old('message', $comment->body) }}</textarea>
